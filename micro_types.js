...
Drupal.behaviors.contentTypes = {
  attach: function (context) {
    ...
    $('fieldset#edit-workflow', context).drupalSetSummary(function(context) {
      var vals = [];
      $("input[name^='micro_options']:checked", context).parent().each(function() {
        vals.push(Drupal.checkPlain($(this).text()));
      });
      if (!$('#edit-micro-options-status', context).is(':checked')) {
    ...
    $('fieldset#edit-display', context).drupalSetSummary(function(context) {
      ...
      if (!$('#edit-micro-submitted', context).is(':checked')) {
